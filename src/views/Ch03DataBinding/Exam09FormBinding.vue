                ...
                <div class="input-group mb-2">
                    ...
                    <div class="form-control">
                        <div class="form-check form-check-inline">
                            <input id="chekboxBlack" class="form-check-input" type="checkbox" value="black"
                                v-model="product.colors">
                            <label class="form-check-label" for="chekboxBlack">블랙</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="chekboxRed" class="form-check-input" type="checkbox" value="red"
                                v-model="product.colors">
                            <label class="form-check-label" for="chekboxRed">레드</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="chekboxYellow" class="form-check-input" type="checkbox" value="yellow"
                                v-model="product.colors">
