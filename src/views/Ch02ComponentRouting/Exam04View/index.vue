<template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p><RouterLink :to="{name: 'Exam01View'}">Exam01View</RouterLink></p>
            <hr/>

            <h5> 프로그램으로 화면 이동 </h5>
            <p><button class="btn btn-info btn-sm" v-on:click="goUrl('Exam01View')">Exam01View</button></p>
            <p><button class="btn btn-info btn-sm" @click="goUrl('Exam01View')">Exam02View</button></p>
        </div>
    </div>
</template>
...
function goUrl(kind){
    router.push("/Ch02ComponentRouting/" + kind).then(() => {
        console.log("이동 완료");
    });
}
</script>
