            ...
            <form @submit.prevent="handleSubmit">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div v-if="board.battachoname !== null">
                        <img width="300" :src="`${axios.defaults.baseURL}/board/battach/${board.bno}?accessToken=${$store.state.accessToken}`" />
                    </div>
...
//Path Variable & QueryString 전달된 bno 얻기
let bno;
let pageNo;
if (route.query.bno == null) {
    bno = route.params.bno;
    pageNo = route.params.pageNo;
} else {
    bno = route.query.bno;
